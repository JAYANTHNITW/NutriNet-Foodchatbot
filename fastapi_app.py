    ...
    if session_id not in inprogress_orders:
        ...
        if order_id ==-1:
            ...
            fulfillment_text = f"Awesome. We have placed your order. " \
                            ...
                            f">>>>>>>. "\
                            f"Pls enter the city name from the following: Warangal, Khammam, Hanamkonda and Kazipet"
...
def order_city(parameters: dict, session_id: str):
    try:
        ...
        return JSONResponse(content={
            "fulfillmentText": "Please Enter one among following locations: NIT warangal, Indira Nagar, Gandhi Nagar, NTR Nagar, Old Ghanpur,  Subedari Nagar,  Bhavani Nagar, Shivaji Nagar, Saraswathi Nagar"
        })
...
def order_phono(parameters: dict, session_id: str):
    try:
        ...
        return JSONResponse(content={
            "fulfillmentText": "A big thank you for placing an order with JayFastFoods. We hope you enjoy your meal!"
        })
